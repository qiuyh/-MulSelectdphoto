...
- (void)createToolbar
{
    ...
    _selectImageBtn.frame = CGRectMake(self.view.frame.size.width-40, 30, 30, 30);
    _selectImageBtn.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [_selectImageBtn setImage:[UIImage imageNamed:@"photo_check_selected.png"] forState:UIControlStateNormal];
...
-(void)selectImage:(UIButton *)sender
{
    if (_is_selectImageBtnBool == YES) {
        ...
        [sender setImage:[UIImage imageNamed:@"photo_check_default.png"] forState:UIControlStateNormal];
    ...
    }else
    {
        ...
        _is_selectImageBtnBool = YES;
        [sender setImage:[UIImage imageNamed:@"photo_check_selected.png"] forState:UIControlStateNormal];
    }
